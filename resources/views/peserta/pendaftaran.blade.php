...
<body style="background-color: #E6DDC4;">
...
<div class="container">
    <h1 style="text-align:center;">Pendaftaran Tes COVID 19</h1>
    <form action="/pendaftarancovid" method="post">
      @method('GET')
      @csrf
  <div class="form-group border border-dark" style="padding:20px;">
    <label for="exampleInputEmail1" class="float-left">NPM</label>
    <input type="text" class="form-control" name="npm" id="exampleInputEmail1" aria-describedby="npm" placeholder="Masukkan NPM Disini">
  </div>
